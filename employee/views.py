...
def userPostListView(request,username):
    ...
    return render(request, "employee/user_post.html",context)
...
class BlogListView(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'employee/blog_list.html'
...
class BlogCreateView(LoginRequiredMixin, CreateView):
    model = Blog
    fields = ['text','picture']
    template_name = 'employee/create_blog.html'
    success_url = '/#blog'
...
class BlogDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Blog
    template_name = 'employee/delete_blog.html'
...
class BlogUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Blog
    fields = ['text','picture']
    template_name = 'employee/update_blog.html'
    success_url = '/#blog'
...
class BlogDetailView(LoginRequiredMixin, DetailView):
    model = Blog
    template_name = 'employee/blog_detail.html'
    context_object_name = 'blog'
...
class BlogCommentDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Comment
    template_name = 'employee/delete_comment.html'
...
class BlogCommentUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Comment
    fields = ['text','picture']
    template_name = 'employee/update_comment.html'
    success_url = '/'
...
class SkillsCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'employee/add_skills.html'
    success_url = '/#skills'
...
class SkillsDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Skills
    template_name = 'employee/delete_skills.html'
...
class SkillsUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Skills
    fields = ['skill','percentage']
    template_name = 'employee/update_skills.html'
    success_url = '/#skills'
...
class CertificateCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'employee/add_certificate.html'
...
class CertificateDetailView(LoginRequiredMixin, DetailView):
    model = Certificate
    template_name = 'employee/certificate_detail.html'
    context_object_name = 'certificate'

class CertificateDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Certificate
    template_name = 'employee/delete_certificate.html'
    context_object_name = 'certificate'
    success_url = '/#certificate'
...
class CertificateUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Certificate
    fields = ['certificate_pic','certificate_title','source']
    template_name = 'employee/update_certificate.html'
    success_url = '/#certificate'
...
class EducationCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'employee/add_education.html'
...
class EducationDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Education
    template_name = 'employee/delete_education.html'
...
class EducationUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Education
    fields = ['start_year','end_year','dgree_name','about','dgree_document']
    template_name = 'employee/update_education.html'
    success_url = '/#education'
...
class ProjectCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'employee/add_project.html'
    success_url = '/#project'
...
class ProjectDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Project
    template_name = 'employee/delete_project.html'
    context_object_name = 'project'
    success_url = '/#project'
...
class ProjectUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    model = Project
    fields = ['project_name','contribution','about_project','github_project_link','main_thumbnial','thumbnial_1','thumbnial_2','thumbnial_3']
    template_name = 'employee/update_project.html'
    success_url = '/#project'
...
class HobbyCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'employee/add_hobby.html'
    success_url = '/#hobbies'
...
class HobbyDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Hobby
    template_name = 'employee/delete_hobby.html'
...
class ProfileListView(LoginRequiredMixin,ListView):
    model = Profile
    template_name = 'employee/profile_search.html'
...
class FollowsListView(ListView):
    model = Follow
    template_name = 'employee/follow.html'
